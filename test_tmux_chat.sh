...
# Change to the rust-p2p-chat directory
cd /home/xian/local/RustChat/rust-p2p-chat || exit 1
...
tmux send-keys -t p2p-demo:chat.1 './target/release/rust-p2p-chat --connect localhost:8080 --nickname Bob' C-m
