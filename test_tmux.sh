...
tmux send-keys -t p2p-chat:0.0 'cargo run --bin rust-p2p-chat -- -p 8080 -c 127.0.0.1:8081' C-m

# Wait a moment
sleep 1

# Run peer 2 in right pane
tmux send-keys -t p2p-chat:0.1 'cargo run --bin rust-p2p-chat -- -p 8081 -c 127.0.0.1:8080' C-m
